  ...
  <div class="container">
    <div class="newRoom">
      <div class="newRoom__inputs">
        <div class="newRoom__searchVid bg-gray-400 dark:bg-gray-500">
          <input type="text" placeholder="Enter a youtube video URL" class="bg-white text-black dark:text-white dark:bg-gray-800 ">
        </div>
    ...
    <div class="videoRoom">
      ...
      <div class="videoRoom__chatPanel">
        <div class="videoRoom__settings">
          ...
          <img src="../assets/icons/view-more.svg" alt="settings-icon">
        </div>
...
.videoRoom {
  ...
  &__messageInfo {
    height: 100%;
    @include base.flexColumn(flex-start, space-between)
  }
  &__sender {
    @include base.flexRow(center, center);
    p{
